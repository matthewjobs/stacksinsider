...
exports.GetTransactionListTypeEnum = exports.GetMempoolTransactionListOrderEnum = exports.GetMempoolTransactionListOrderByEnum = exports.GetFilteredEventsTypeEnum = exports.TransactionsApi = void 0;
...
class TransactionsApi extends runtime.BaseAPI {
     ...
     */
    async getAddressTransactionEventsRaw(requestParameters, initOverrides) {
        if (requestParameters.address === null || requestParameters.address === undefined) {
            throw new runtime.RequiredError('address', 'Required parameter requestParameters.address was null or undefined when calling getAddressTransactionEvents.');
        }
        if (requestParameters.txId === null || requestParameters.txId === undefined) {
            throw new runtime.RequiredError('txId', 'Required parameter requestParameters.txId was null or undefined when calling getAddressTransactionEvents.');
        }
        const queryParameters = {};
        if (requestParameters.limit !== undefined) {
            queryParameters['limit'] = requestParameters.limit;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.AddressTransactionEventListResponseFromJSON)(jsonValue));
    }
    /**
     * Retrieves a paginated list of all STX, FT and NFT events concerning a STX address or Smart Contract ID within a specific transaction.
     * Get events for an address transaction
     */
    async getAddressTransactionEvents(requestParameters, initOverrides) {
        const response = await this.getAddressTransactionEventsRaw(requestParameters, initOverrides);
        return await response.value();
    }
    /**
     ...
     */
    async getAddressTransactionsRaw(requestParameters, initOverrides) {
        if (requestParameters.address === null || requestParameters.address === undefined) {
            throw new runtime.RequiredError('address', 'Required parameter requestParameters.address was null or undefined when calling getAddressTransactions.');
        }
        const queryParameters = {};
        if (requestParameters.limit !== undefined) {
            queryParameters['limit'] = requestParameters.limit;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.AddressTransactionsV2ListResponseFromJSON)(jsonValue));
    }
    /**
     * Retrieves a paginated list of confirmed transactions sent or received by a STX address or Smart Contract ID, alongside the total amount of STX sent or received and the number of STX, FT and NFT transfers contained within each transaction.  More information on Transaction types can be found [here](https://docs.stacks.co/understand-stacks/transactions#types).
     * Get address transactions
     */
    async getAddressTransactions(requestParameters, initOverrides) {
        const response = await this.getAddressTransactionsRaw(requestParameters, initOverrides);
        return await response.value();
    }
    /**
...
})(GetFilteredEventsTypeEnum || (exports.GetFilteredEventsTypeEnum = GetFilteredEventsTypeEnum = {}));
/**
    * @export
    * @enum {string}
    */
var GetMempoolTransactionListOrderByEnum;
...
})(GetMempoolTransactionListOrderByEnum || (exports.GetMempoolTransactionListOrderByEnum = GetMempoolTransactionListOrderByEnum = {}));
/**
    * @export
    * @enum {string}
    */
var GetMempoolTransactionListOrderEnum;
...
})(GetMempoolTransactionListOrderEnum || (exports.GetMempoolTransactionListOrderEnum = GetMempoolTransactionListOrderEnum = {}));
/**
    * @export
    * @enum {string}
    */
...
})(GetTransactionListTypeEnum || (exports.GetTransactionListTypeEnum = GetTransactionListTypeEnum = {}));
