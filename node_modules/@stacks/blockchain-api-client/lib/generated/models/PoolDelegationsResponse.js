...
exports.PoolDelegationsResponseToJSON = exports.PoolDelegationsResponseFromJSONTyped = exports.PoolDelegationsResponseFromJSON = void 0;
const _1 = require("./");
...
function PoolDelegationsResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'offset': json['offset'],
        'total': json['total'],
        'results': (json['results'].map(_1.PoolDelegationFromJSON)),
    };
}
...
function PoolDelegationsResponseToJSON(value) {
    ...
    return {
        ...
        'offset': value.offset,
        'total': value.total,
        'results': (value.results.map(_1.PoolDelegationToJSON)),
    };
}
exports.PoolDelegationsResponseToJSON = PoolDelegationsResponseToJSON;
//# sourceMappingURL=PoolDelegationsResponse.js.map